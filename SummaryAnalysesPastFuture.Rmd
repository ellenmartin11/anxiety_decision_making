...
```{r Summary Plot Percent Risk-Taking Based on Future in Gain Domain}
...
```{r Summary Plot Percent Risk-Taking Based on Future in Gain Domain and Diagnosis}
...
```{r Summary Plot Percent Risk-Taking Based on Future in Gain Domain and Depression Diagnosis}
...
```{r Summary Plot Percent Risk-Taking Based on Past in Gain Domain and Anxiety Diagnosis}
